...
class TestMcp(SkaldTestCase):
    ...
    def test_tools_end_to_end(self):
        ...
        ans, _ = self.call(server, "skald_answer", id=a, text="5000", question=1, **{"as": "jon"})
        self.assertEqual((ans["closed_questions"], ans["questions"]["open"]), (1, 1))
        ans, _ = self.call(server, "skald_answer", id=a, text="cookies", **{"as": "jon"})
