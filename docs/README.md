...
| [The board](board.md) | You want every board feature in one place: columns, filters, swimlanes, branches, multi-select, graph, shortcuts. |
| [Stories](stories.md) | You want the story file format, columns and roles, facets and epics, templates, archiving, and releases. |
...
| [Multiple projects](multi-project.md) | You have more than one repository, or want cross-project dependencies and one board for all of them. |
