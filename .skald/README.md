<!-- skald-render 34ddfe20b223d55a -->
# skald backlog

**1 open** · Idea 1 · Plan 0 · Ready 0 · In progress 0 · Review 0 · Done 11
...
<details><summary><strong>Done (11)</strong></summary>

| ID | Title | Tags | Assignee | Blocked by | Progress |
| --- | --- | --- | --- | --- | --- |
| [527a9c](stories/527a9c-target-release-tag-and-a-release-warning.md) | Target-release tag and a release warning | `roadmap` | claude |  |  |
| [1a5064](stories/1a5064-story-references-in-notes-resolve-on-the-board-and.md) | Story references in notes resolve on the board and in show | `roadmap` | claude |  |  |
...
| [e1ef91](stories/e1ef91-open-questions-at-the-top-of-the-rendered-board.md) | Open questions at the top of the rendered board | `roadmap` | claude |  |  |
| [d5cd0f](stories/d5cd0f-a-conventions-page-the-facets-and-what-each-unlock.md) | A conventions page: the facets and what each unlocks | `docs` `roadmap` | claude |  |  |
| [9c5d75](stories/9c5d75-skald-doctor-one-command-for-why-it-is-not-working.md) | skald doctor: one command for why it is not working | `roadmap` | claude |  | 0/7 |
| [18c326](stories/18c326-browse-what-shipped-by-release-on-the-board.md) | Browse what shipped, by release, on the board | `roadmap` | claude |  |  |
| [a729bb](stories/a729bb-rendered-board-doc-lists-what-shipped-grouped-by-r.md) | Rendered board doc lists what shipped, grouped by release | `roadmap` | claude |  |  |
