...
The test suite runs on Linux for Python 3.9 to 3.13 and on macOS and Windows for 3.12, and the background server and git path handling were fixed where those platforms differed.
